...
class AdditionRNNEnvironment:
    def __init__(self, model, signal, train_size, val_size, val_dist, writer=None):
        self.model = model
    ...
    def step(self, train_dist):
        ...
        train_data_double = self.model.generate_data(train_dist, self.train_size)
...
#        val_accs = self.model.accuracy_per_length(*self.val_data)
        ...
        if self.writer:
            ...
            for i in range(self.num_actions):
                ...
                add_summary(self.writer, "accuracies/task_%d" % (i + 1), accs[i], self.model.epochs)
